public class PhraseOMatic {
  public static void main(String [] args) {
    ...
    String [] wordListTwo = {"habilitado", "adesivo", "valor agregado",
    "orientado", "central", "distribuído", "agrupado", "solidificado",
    "independente de máquina", "posicionado", "em rede", "dedicado",
    "alavancado", "alinhado", "destinado", "compartilhado", "cooperativo",
    "acelerado"};

    String [] wordListTree = {"processo", "ponto máximo", "solução", "arquitetura",
