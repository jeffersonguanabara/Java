package br.unipe.ED.projeto_Unidade_2;

import javax.swing.JOptionPane;

import br.unipe.ED.aula_09_Pilha_Sequencial.PilhaSequencial;
import br.unipe.ED.aula_10_Pilha_Encadeada.PilhaEncadeada;
import br.unipe.ED.aula_11_Fila_Sequencial.FilaSequencial;
import br.unipe.ED.aula_12_Fila_Encadeada.FilaEncadeada;
...
public class Principal {
	...
	public static void menuPrincipalPilhaSequencial() {
		...
		switch (opcao) {
		case 1:
			String nome = JOptionPane.showInputDialog("Informe o nome da pessoa a inserir na fila");
			System.out.println(pilhaSequencial.push(nome));
			break;
		case 2:
			JOptionPane.showMessageDialog(null, pilhaSequencial.pop());
			break;
		case 3:
			JOptionPane.showMessageDialog(null, pilhaSequencial.elementoTopo());
			break;
		case 4:
			JOptionPane.showMessageDialog(null, pilhaSequencial.exibirElementos());
			break;
		case 5:
			menuRun();
			break;
	...
	public static void menuPrincipalPilhaEncadeada() {
		...
		case 1:
			...
			break;
		case 2:
			String temp = pilhaEncadeada.pop();
			JOptionPane.showMessageDialog(null, temp);
			break;
		case 3:
			JOptionPane.showMessageDialog(null, pilhaEncadeada.getTopo());
			break;
		case 4:
			JOptionPane.showMessageDialog(null, pilhaEncadeada.exibirElementos());
			break;
		case 5:
			menuRun();
			break;
	...
	public static void menuPrincipalFilaSequencial() {
		...
		case 2:
			...
			break;
		case 3:
			JOptionPane.showMessageDialog(null, filaSequencial.remover());
			break;
		case 4:
			JOptionPane.showMessageDialog(null, filaSequencial.exibirFila());
			break;
		case 5:
			menuRun();
			break;
	...
	public static void menuPrincipalFilaEncadeada() {
		...
		case 2:
			...
			break;
		case 3:
			JOptionPane.showMessageDialog(null, filaEncadeada.remover());
			break;
		case 4:
			JOptionPane.showMessageDialog(null, filaEncadeada.exibirFila());
			break;
		case 5:
			menuRun();
			break;
