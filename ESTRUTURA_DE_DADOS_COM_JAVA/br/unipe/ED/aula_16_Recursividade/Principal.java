package br.unipe.ED.aula_16_Recursividade;
...
public class Principal {
	...
	public static void main(String[] args) {
		 ...
		 * Scanner teclado = new Scanner(System.in); int n = teclado.nextInt(); int
		 * resultado = calculadoFatorial(n);
		 */

		/*
		 * System.out.println("Informe o primeiro numero: "); Scanner teclado = new
		 * Scanner(System.in); int a = teclado.nextInt();
		 * System.out.println("Informe o segundo numero: "); int b = teclado.nextInt();
