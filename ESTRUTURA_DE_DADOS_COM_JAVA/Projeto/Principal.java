...
import Aula_04_Lista_Sequencial.*;
import Aula_04_Lista_Sequencial.Lista;
import Aula_05_Lista_Simplemente_Encadeada.*;
...
public class Principal {
	...
	public static void main(String[] args) {
		...
		do {
			try {
				System.out.println("Informe qual lista você quer usar: \n(1) Lista Sequencial\n(2) Lista Simplesmente Encadeada\n(0) Sair");
